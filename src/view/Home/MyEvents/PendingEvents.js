...
class PendingEvents extends Component {
    ...
    _renderEmptyComponent() {
        return !this.state.loading && isEmpty(this.state.Events) && <FLEC text="There Are Currently No Upcoming Events"
        ...
        return (
            <View
                ...
                <View style={{ marginHorizontal: 5, flex: 1 }}>
                    ...
                    <Text style={styles.textheading}>{"Upcoming Events"}</Text>
