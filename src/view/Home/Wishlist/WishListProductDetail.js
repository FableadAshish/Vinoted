...
class WishListProductDetail extends Component {
    ...
    Store = async () => {
        ...
        http.get(`sommelier/product/${form.id}`).then(res => {
            ...
            <View
                ...
                {isEmpty(ProductDetail) && this.state.loading ?
                    ...
                    />
                        ...
                        // }
                        >
                            {!isEmpty(ProductDetail)&& <View style={{flex:1}}>
                            ...
                            <Icon name={isLike ? "heart" : "hearto"} style={{ color: isLike ? "red" : "gray" }} />
                                ...
                                <View style={[styles.view, { flexDirection: "row", marginHorizontal: 5, marginBottom: 20, }]}>
                                    <View style={{ flexDirection: 'column', flex: 0.7 }}>
                                        <View style={{ marginVertical: 5, }}>
                                            <Text style={[styles.textheading, { fontWeight: "700" }]}>{ProductDetail.product.title}</Text>
                                        ...
                                        <View style={{ marginVertical: 5 }}>
                                            ...
                                            <Text style={{ fontFamily: sofiaFont, fontSize: 20, fontWeight: "700", color: primaryColor }}>{ProductDetail.product.year}</Text>
                                        </View>

                                        <View style={{ marginVertical: 5 }}>
                                            <Text style={{ color: "gray" }}>Alcohol</Text>
                                            <Text style={{ fontFamily: sofiaFont, fontSize: 20, fontWeight: "700", color: primaryColor }}>{ProductDetail.product.alcohol}%</Text>
                                        </View>

                                        {!isEmpty(ProductDetail) && !isNull(ProductDetail.event) && ProductDetail.event.is_started==1 &&<View style={{ marginVertical: 5 }}>
                                            <Text style={{ color: "gray" }}>Tasted on</Text>
                                            <Text style={{ fontFamily: sofiaFont, fontSize: 20, fontWeight: "700", color: primaryColor }}>{moment(ProductDetail.created_at).format("DD MMM,YYYY")}</Text>
                                        </View>}

                                    </View>

                                    <View style={{ flexDirection: 'column', flex: 0.3 }}>
                                        <Image style={{ height: "100%", width: "100%", marginTop: 20 }} resizeMode="contain"
                                ...
                                <View style={{ justifyContent: "center", alignItems: "flex-end", paddingHorizontal: 10, height: 50, width: '90%', backgroundColor: secondryColor, borderTopRightRadius: 30, borderBottomRightRadius: 30, marginVertical: 10 }}>
                                    <View style={{ flexDirection: "row", alignItems: "center" }}>
                                        ...
                                        <Text style={[styles.textheading, { color: white }]}>{ProductDetail.product.price}</Text>
                                    </View>
                                    ...
                                    <View style={{ flexDirection: 'row', width: "95%", flex: 1, alignSelf: "center" }}>
                                        <View style={{ flexDirection: 'column', flex: 0.5, paddingHorizontal: 10 }}>
                                            <View style={{ marginVertical: 5 }}>
                                                ...
                                                <Text style={{ fontFamily: sofiaFont, fontSize: 15, color: primaryColor }}>{ProductDetail.product.type}</Text>
                                            </View>
                                            <View style={{ marginVertical: 5 }}>
                                                <Text style={{ color: "gray" }}>Region</Text>
                                                <Text style={{ fontFamily: sofiaFont, fontSize: 15, color: primaryColor }}>{ProductDetail.product.region}</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={{ flexDirection: 'column', flex: 0.5, paddingHorizontal: 10 }}>
                                            <View style={{ marginVertical: 5 }}>
                                                ...
                                                <Text style={{ fontFamily: sofiaFont, fontSize: 15, color: primaryColor }}>{ProductDetail.product.country}</Text>
                                            </View>
                                            {/* <View style={{ marginVertical: 5 }}>
                                ...
                                <View style={[styles.view, { marginHorizontal: 5 }]}>
                                    <HTML style={{ fontSize: 15,color:primaryColor }} html={ProductDetail.product.description} imagesMaxWidth={Dimensions.get('window').width - 20} />
                                </View>
                    ...
                    />
                        : (
                            !isEmpty(ProductDetail) && !isNull(ProductDetail.event) && ProductDetail.event.is_started==1 &&
                            <TouchableOpacity
                                onPress={() => !isEmpty(ProductDetail) && ProductDetail.event.is_started==1 && this.props.navigation.navigate("ChooseProduct",{ Testing:ProductDetail,event:ProductDetail.event })} 
                                style={{
                                    ...
                                    borderBottomRightRadius: 30, marginVertical: 10, position: "absolute", bottom: 0
                                }}>
                                <View style={{ flexDirection: "row", alignItems: "center" }}>
                                    {/* <Icon name="pound" type="Foundation" style={{ color: white, fontSize: 30, paddingTop: 5, marginHorizontal: 5 }} /> */}
