...
import {
    ...
    secondryColor,
    primaryColor,
    cardBackground, error, black,sofiaFont
                ...
                >
                    <View style={{ marginHorizontal: 5 }}>
                        ...
                        <View style={[styles.view, { flexDirection: "row", marginHorizontal: 5 }]}>
                            ...
                            <View style={{ flexDirection: 'column', flex: 0.7 }}>
                                ...
                                <View style={{ marginVertical: 5, }}>
                                    <Text style={[styles.textheading, { fontWeight: "700" }]}>{Testing.products.title}</Text>
                                ...
                                <View style={{ marginVertical: 5 }}>
                                    ...
                                    <Text style={{fontFamily:sofiaFont, fontSize: 20, fontWeight: "700", color: primaryColor }}>{Testing.products.year}</Text>
                                </View>

                                <View style={{ marginVertical: 5 }}>
                                    <Text style={{ color: "gray" }}>Alcohol</Text>
                                    <Text style={{fontFamily:sofiaFont, fontSize: 20, fontWeight: "700", color: primaryColor }}>{Testing.products.alcohol}</Text>
                                </View>

                                <View style={{ marginVertical: 5 }}>
                                    <Text style={{ color: "gray" }}>Tested on</Text>
                                    <Text style={{ fontSize: 20, fontWeight: "700",fontFamily:sofiaFont, color: primaryColor }}>10 Feb,2021</Text>
                                </View>
                                {/* <View style={{ marginVertical: 5 }}>
                        ...
                        <View style={[styles.view, { marginHorizontal: 5 }]}>
                            ...
                            <TouchableOpacity style={{ paddingVertical: 10, width: "100%", alignSelf: "center", alignItems: "center", flexDirection: "row", }} onPress={() => this.setState({ is_favourite: !this.state.is_favourite })}>
                                <Icon name={is_favourite ? "heart" : "hearto"} type="AntDesign" style={{ color: is_favourite ? primaryColor : "gray" }} />
